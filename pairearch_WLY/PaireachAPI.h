...
/*============================BaseUrl相关=============================*/
//API前缀定义
#define PAIREACH_BIDDING_URL             @"http://139.196.127.215:8285/itip/clientBid/"  //竞价中心
//#define PAIREACH_BIDDING_URL             @"http://192.168.0.188:8085/itip/clientBid/"  //竞价中心Ada本地


#define PAIREACH_BASE_URL                @"http://139.196.127.215:8285/itip/client/"       //测试线上
//#define PAIREACH_BASE_URL                @"http://192.168.0.188:8085/itip/client/"      //Ada本地IP
